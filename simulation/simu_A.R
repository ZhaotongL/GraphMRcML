...
Stroke_iv = which(pval_mat[,'Stroke']<5e-8)

b[BMI_iv,'BMI'] = b_mat[BMI_iv,'BMI']
b[BMI_iv,'FG'] = G['BMI','FG']*b[BMI_iv,'BMI']
b[BMI_iv,'TG'] = G['BMI','TG']*b[BMI_iv,'BMI']
b[BMI_iv,'CAD'] = (0.23+0.31*0.07)*b[BMI_iv,'BMI']
b[BMI_iv,'Stroke'] = 0.23*(0.23+0.31*0.07)*b[BMI_iv,'BMI']
b[LDL_iv,'LDL'] = b_mat[LDL_iv,'LDL']  
b[LDL_iv,'CAD'] = 0.41*b[LDL_iv,'LDL']
b[LDL_iv,'Stroke'] = 0.23*0.41*b[LDL_iv,'LDL']
b[FG_iv,'FG'] = b_mat[FG_iv,'FG'] 
b[FG_iv,'CAD'] = 0.31*b[FG_iv,'FG']
b[FG_iv,'Stroke'] = 0.23*0.31*b[FG_iv,'FG']
b[TG_iv,'TG'] = b_mat[TG_iv,'TG'] 
b[CAD_iv,'CAD'] = b_mat[CAD_iv,'CAD'] 
b[CAD_iv,'Stroke'] = 0.23*b[CAD_iv,'CAD']
b[Stroke_iv,'Stroke'] = b_mat[Stroke_iv,'Stroke']  
